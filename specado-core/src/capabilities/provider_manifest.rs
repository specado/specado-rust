...
use crate::capabilities::{
    Capability, Constraints, ControlParameters, ModalitySupport, ModelFeatures, ParameterSupport,
    RoleSupport,
};
    ...
    pub fn openai() -> Self {
        ...
        models.insert(
            ...
            ModelManifest {
                ...
                description: Some(
                    "Most capable GPT-4 model with vision and function calling".to_string(),
                ),
                capabilities: Capability {
                    ...
                    modalities: {
                        ...
                        m.configs.image =
                            Some(crate::capabilities::modality::ImageConfig::default());
                        m
                    },
