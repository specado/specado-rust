...
use specado_core::protocol::types::{ChatRequest, Message, MessageRole, MessageContent};
use specado_core::providers::adapter::ProviderType;
use specado_core::providers::routing::{ProviderError, PrimaryWithFallbacks, RoutingStrategy};
...
fn test_request_options() {
    ...
    assert_eq!(options_with_timeout.timeout, std::time::Duration::from_secs(60));
}
